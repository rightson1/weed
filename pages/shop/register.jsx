...
const Register = () => {
    ...
    return <div className="overflow-x-hidden  flex flex-col bg-white" >
        <div className="item  w-full flex justify-center py-4">
            <img src="kindu.png" alt="" className="max-w-[200px] md:max-w-[300px]" />
        </div>
        <form className="flex flex-col" onSubmit={handleSubmit}>
            <h1 className="text-green text-center">CUSTOMER REGISTERATION FORM</h1>
            <div className="flex flex-col  w-full justify-center items-center mt-7 px-8 gap-8">
                ...
                <p>Already have an account? <span className="text-green cursor-pointer" onClick={() => router.push("/shop/login")}>Login</span></p>
